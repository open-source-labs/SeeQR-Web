...
var queryController = {
    ...
    executeQueryTracked: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, queryString, queryLabel, users, options, response, data, url, pool, rows, queryStats;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    pool = users[req.cookies['session_id']];
    ...
    generateDummyData: function (req, res, next) {
        next();
    },
};
